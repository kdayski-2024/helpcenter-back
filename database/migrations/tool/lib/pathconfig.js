...
module.exports = function (options) {
    ...
    let migrationsDir = path.join(process.env.PWD, 'database/migrations'),
        modelsDir = path.join(process.env.PWD, 'database/models');
    databaseDir = path.join(process.env.PWD, 'database');
